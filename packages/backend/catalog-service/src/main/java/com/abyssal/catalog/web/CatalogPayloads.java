...
public final class CatalogPayloads {
  ...
  public record MenuItemUpsertRequest(
    ...
    @NotBlank @Pattern(regexp = "^(entradas|principais|sobremesas|bebidas)$", message = "a categoria deve ser uma de entradas, principais, sobremesas ou bebidas.") String category,
  ...
  public record MenuItemUpdateRequest(
    ...
    @Pattern(regexp = "^(entradas|principais|sobremesas|bebidas)$", message = "a categoria deve ser uma de entradas, principais, sobremesas ou bebidas.") String category,
    @Min(1) @Max(1000000) Integer priceCents,
    Boolean isFeatured,
    @Size(max = 80) String imageHint,
    @Size(max = 300) String imageUrl,
